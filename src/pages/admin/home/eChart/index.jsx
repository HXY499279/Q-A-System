...
import {reqLoginStatistic,reqQuestionStatistic} from '@/api/index'
export default class EChart extends Component {
    async componentDidMount () {
        ...
        //?七天登录人数变化（折线图）
        let myChart1 = echarts.init(document.querySelector(".echart-content1-line"));
        let option1 =  {
            tooltip: {
                trigger: 'axis'
            },
        ...
        //?七天回答、提问数量变化（折线图）
        let myChart2 = echarts.init(document.querySelector(".echart-content2-line"));
        let option2 =  {
            tooltip: {
                trigger: 'axis'
            },
        ...
        //?各学院登录数量分布（饼状图）
        let myChart3 = echarts.init(document.querySelector(".echart-content1-bar"));
        let option3 = {
            title: {
                text: '各学院登录数量分布',
                left: 'center',
